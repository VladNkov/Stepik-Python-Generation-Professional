...
#
# [datetime.date(2021, 1. Repetition tasks, 4. Data type namedtuple. Working with files), datetime.date(2021, 1. Repetition tasks, 11), ..., datetime.date(2021, 12, 20), datetime.date(2021, 12, 27)]
# Примечание 2. Data type set and dict.txt. В тестирующую систему сдайте программу, содержащую только необходимую функцию get_all_mondays(),
